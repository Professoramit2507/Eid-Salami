...
// Sample student data with 31 students
const students = Array.from({ length: 31 }, (_, i) => ({
  ...
  dept: "CSE",
  imageUrl: "https://img.icons8.com/?size=100&id=RsUHUPu4M660&format=png&color=000000", // Placeholder image URL
}));
...
const Cse6 = () => {
  ...
  const handleRequestClick = (studentId) => {
    ...
    // Show success toast and mark request as sent
